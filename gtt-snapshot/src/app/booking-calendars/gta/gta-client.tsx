...
export function GtaClient({ consultants }: { consultants: Consultant[] }) {
  ...
  if (consultants.length === 0) {
    return (
      <p className="text-muted-foreground">No GTA consultants found. Add consultants with the title &quot;GTA&quot; in the admin panel.</p>
    );
  }
