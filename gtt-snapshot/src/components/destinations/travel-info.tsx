...
const advisoryColors: Record<number, { bg: string; text: string; dot: string }> = {
  1: { bg: "bg-green-50", text: "text-green-800", dot: "bg-green-500" },
  2: { bg: "bg-yellow-50", text: "text-yellow-800", dot: "bg-yellow-500" },
  3: { bg: "bg-orange-50", text: "text-orange-800", dot: "bg-orange-500" },
  4: { bg: "bg-red-50", text: "text-red-800", dot: "bg-red-500" },
};
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        {hasAdvisory && advisoryStyle && (
          <Card className={`flex-1 ${advisoryStyle.bg} border-0`}>
            <CardContent className="py-3 px-4">
              ...
              <p className={`text-xs mt-1 ${advisoryStyle.text} opacity-80`}>
